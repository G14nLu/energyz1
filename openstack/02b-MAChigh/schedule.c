...
//	if(slotOffset == 5){
//	   openserial_printInfo(255,150,
//					   (errorparameter_t)slotOffset,
//					   (errorparameter_t)schedule_vars.currentScheduleEntry->next
//					   );
//	}
//	if(slotOffset == 2){
//		   openserial_printInfo(255,151,
//						   (errorparameter_t)slotOffset,
//						   (errorparameter_t)slotContainer->next);
//	}
